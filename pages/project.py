...
ax1.bar(wepc.index,wepc['S'],color='blue')
ax2.bar(wepc.index,wepc['N'],color='blue')
ax3.bar(wepc.index,wepc['E'],color='blue')
ax4.bar(wepc.index,wepc['W'],color='blue')
st.pyplot(fig)
...
ax3 = fig.add_subplot(2, 2, 3)
ax4 = fig.add_subplot(2, 2, 4)
ax1.bar(weph.index,weph['S'],color='red')
ax2.bar(weph.index,weph['N'],color='red')
ax3.bar(weph.index,weph['E'],color='red')
ax4.bar(weph.index,weph['W'],color='red')
st.pyplot(fig)
